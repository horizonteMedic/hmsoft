...
private void reporte(Integer cod) throws IOException{
   String dniUsuario=oPe.consultarDni("consentimiento_dosaje", String.valueOf(cod));
                String dniPaciente=oPe.consultarDniPaciente("consentimiento_dosaje", "n_orden", String.valueOf(cod));
                String base64Huella="";
                String base64FirmaP="";
                String base64Sello=""; 
       try {
        ...
        parameters.put("Norden", cod);
              ...
              if(!base64Sello.contains("OTROJASPER"))
              {
                 ...
                 try 
                {
                    ...
                    if(chkMarihuna.isSelected())
                       master = System.getProperty("user.dir") +"/reportes/ConsentimientoDosaje1_Digitalizado.jasper";
                    else{
                        master = System.getProperty("user.dir") +"/reportes/ConsentimientoDosaje_Digitalizado.jasper";}                    
                    }
...
private boolean Grabar() throws SQLException{
       ...
       String strSqlStmt ="INSERT INTO consentimiento_dosaje("
               + "n_orden,fecha_dosaje, chk1_si, chk2_si, chk3_si, chk1_no, chk2_no,chk3_no,edad_dosaje,user_registro)";       
            ...
            strSqlStmt += chk1_NO.isSelected()+"','" +chk2_NO.isSelected()+"','"+chk3_NO.isSelected()+"','"+txtEdad.getText()+"','"+clsGlobales.sUser+"')";   
