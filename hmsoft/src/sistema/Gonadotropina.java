...
"                   WHERE t.n_orden ="+txtNorden.getText()+";";
    ...
    private void printer(Integer cod) throws IOException {
        String dniUsuario=oPe.consultarDni("lgonadotropina", String.valueOf(cod));
                String base64Sello=""; 
       try {
              ...
              if(!base64Sello.contains("OTROJASPER"))
              {
                ...
                {    
                   ...
                   if( base64Sello.contains("OTROJASPER")){
                       ...
                       direccionReporte = System.getProperty("user.dir")+File.separator+"reportes"+File.separator+"LGonadotropina_Digitalizado.jasper"; 
...
"            n_orden, fecha_examen, txtresultado,user_registro)";
        strSqlStmt += " values(" + txtNorden.getText() + ",'"
                + FechaEx.getDate() + "','"
                + txtResultado.getText() + "','"+clsGlobales.sUser+"')";
        // System.out.println(strSqlStmt);
