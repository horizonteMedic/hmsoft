...
private void printer1(Integer cod){
          ...
          private void printer2(Integer cod) throws IOException{
                String dniUsuario=oPe.consultarDni("cuestionario_nordico", String.valueOf(cod));
                String dniPaciente=oPe.consultarDniPaciente("cuestionario_nordico", "n_orden", String.valueOf(cod));
                String base64Huella="";
                String base64FirmaP="";
                String base64Sello=""; 
       try {
