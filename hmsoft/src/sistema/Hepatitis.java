...
"                   WHERE t.n_orden ="+txtNorden.getText()+";";
    ...
    private void printer(Integer cod) throws IOException {
        String dniUsuario=oPe.consultarDni("lhepatitis", String.valueOf(cod));
                String base64Sello=""; 
       try {
              ...
              if(!base64Sello.contains("OTROJASPER"))
              {
                ...
                {    
                   ...
                   if( base64Sello.contains("OTROJASPER")){
                       ...
                       if(chkHA.isSelected()){     
                        direccionReporte= System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "LHepatitisA_Digitalizado.jasper";
                        }else if(chkHB.isSelected()){
                        direccionReporte= System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "LHepatitisB_Digitalizado.jasper";
                       }else
                        direccionReporte= System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "LHepatitisB_Digitalizado.jasper";                  
                   }
...
"            n_orden, fecha_examen, txtmarca,txthepatitisa, txthepatitisb,user_registro)";
        strSqlStmt += " values(" + txtNorden.getText() + ",'"
                + FechaEx.getDate() + "','"
                + txtMetodo.getText() + "','"
                + txtHepatitisA.getText() + "','"
                + txtHepatitisB.getText() + "','"+clsGlobales.sUser+"')";
        // System.out.println(strSqlStmt);
