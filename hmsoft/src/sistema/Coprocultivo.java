...
"            txtobservaciones,user_registro)";
        strSqlStmt += " values(" + txtNorden.getText() + ",'"
                ...
                + atxtObservaciones.getText() + "','"+clsGlobales.sUser
                + "') ";
...
//                   oConn.setResult.next();
    ...
    private void printer(Integer cod) throws IOException {
        String dniUsuario=oPe.consultarDni("ac_coprocultivo", String.valueOf(cod));
                String base64Sello=""; 
       try {
              ...
              if(!base64Sello.contains("OTROJASPER"))
              {
                ...
                {    
                   ...
                   if( base64Sello.contains("OTROJASPER")){
                       ...
                       direccionReporte = System.getProperty("user.dir")+File.separator+"reportes"+File.separator+"Coprocultivo_Digitalizado.jasper";  
                   }
